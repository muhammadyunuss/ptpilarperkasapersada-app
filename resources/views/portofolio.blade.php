            ...
            <div class="container">
                <div class="page-top-inner d-flex flex-wrap align-items-center position-relative w-100">
                    <div class="page-title-info position-relative">
                        ...
                        <h1 class="mb-0">Portfolio Masonry</h1>
                    ...
                    <div class="page-title-img position-absolute"><div class="page-title-img-inner d-block w-100" style="background-image: url(assets/images/page-title-bg5.jpg);"></div><span class="position-absolute sec-watermark center-watermark overlap-btm-shap88 font-200">Masonry</span></div>
                </div>
            </div>
        </div><!-- Page Top Wrap -->
    </div>
...
<section>
    <div class="w-100 pt-80 pb-100 position-relative">
        <img class="img-fluid overlap-tpshap160 sec-tp-lft-shp opc-03 position-absolute" src="assets/images/sec-shap8.jpg" alt="Sec Shape 8">
        <div class="container">
            <div class="sec-title text-center w-100">
                <div class="sec-title-inner d-inline-block">
                    <span class="d-block thm-clr">Portfolio</span>
                    <h2 class="mb-0">Gorgeous gallery<i></i></h2>
                </div>
            </div><!-- Sec Title -->
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-5">
                        <div class="port-box2 text-center position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img3-1.jpg" alt="Portfolio Image 1">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-7">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="port-box2 text-center position-relative overflow-hidden w-100">
                                    <img class="img-fluid w-100" src="assets/images/resources/port-img3-2.jpg" alt="Portfolio Image 2">
                                    <div class="port-info2 position-absolute">
                                        <h3 class="mb-0"><a href="portfolio-single.html" title="">Modern natural materials</a></h3>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <div class="port-box2 text-center position-relative overflow-hidden w-100">
                                    <img class="img-fluid w-100" src="assets/images/resources/port-img3-3.jpg" alt="Portfolio Image 3">
                                    <div class="port-info2 position-absolute">
                                        <h3 class="mb-0"><a href="portfolio-single.html" title="">Modern natural materials</a></h3>
                                        <span class="d-block position-relative">Architecture</span>
                                        <a class="d-inline-block" href="portfolio-single.html" title=""><i class="icon-share-alt"></i></a>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-8">
                        <div class="port-box2 text-center position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img3-4.jpg" alt="Portfolio Image 4">
                            <div class="port-info2 position-absolute">
                                <h3 class="mb-0"><a href="portfolio-single.html" title="">Modern natural materials</a></h3>
                                <span class="d-block position-relative">Interior</span>
                                <a class="d-inline-block" href="portfolio-single.html" title=""><i class="icon-share-alt"></i></a>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-4">
                        <div class="port-box2 text-center position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img3-5.jpg" alt="Portfolio Image 5">
                            <div class="port-info2 position-absolute">
                                <h3 class="mb-0"><a href="portfolio-single.html" title="">Modern natural materials</a></h3>
                                <span class="d-block position-relative">Architecture</span>
                                <a class="d-inline-block" href="portfolio-single.html" title=""><i class="icon-share-alt"></i></a>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-7">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="port-box2 text-center position-relative overflow-hidden w-100">
                                    <img class="img-fluid w-100" src="assets/images/resources/port-img3-6.jpg" alt="Portfolio Image 6">
                                    <div class="port-info2 position-absolute">
                                        <h3 class="mb-0"><a href="portfolio-single.html" title="">Modern natural materials</a></h3>
                                        <span class="d-block position-relative">Interior</span>
                                        <a class="d-inline-block" href="portfolio-single.html" title=""><i class="icon-share-alt"></i></a>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <div class="port-box2 text-center position-relative overflow-hidden w-100">
                                    <img class="img-fluid w-100" src="assets/images/resources/port-img3-7.jpg" alt="Portfolio Image 7">
                                    <div class="port-info2 position-absolute">
                                        <h3 class="mb-0"><a href="portfolio-single.html" title="">Modern natural materials</a></h3>
                                        <span class="d-block position-relative">Architecture</span>
                                        <a class="d-inline-block" href="portfolio-single.html" title=""><i class="icon-share-alt"></i></a>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-5">
                        <div class="port-box2 text-center position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img3-8.jpg" alt="Portfolio Image 8">
                            <div class="port-info2 position-absolute">
                                <h3 class="mb-0"><a href="portfolio-single.html" title="">Modern natural materials</a></h3>
                                <span class="d-block position-relative">Interior</span>
                                <a class="d-inline-block" href="portfolio-single.html" title=""><i class="icon-share-alt"></i></a>
