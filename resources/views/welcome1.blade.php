            ...
            <div class="blog-wrap res-row position-relative w-100">
                <div class="row align-items-end">
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="blog-post-box-wrap position-relative w-100">
                            <div class="blog-post-box w-100">
                                <div class="blog-post-img position-relative overflow-hidden w-100"><a href="blog-detail.html" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/blog-post-img1-1.jpg" alt="Blog Post Image 1"></a></div>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="blog-post-box-wrap position-relative w-100">
                            <div class="blog-post-box w-100">
                                <div class="blog-post-img position-relative overflow-hidden w-100"><a href="blog-detail.html" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/blog-post-img1-2.jpg" alt="Blog Post Image 2"></a></div>
                                <div class="blog-post-info position-relative w-100">
                                    <a class="thm-bg position-absolute" href="blog-detail.html" title=""><svg viewBox="0 0 28 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M28 8L20.5 14.9282L20.5 1.0718L28 8Z" fill="#1e1e20"/><path d="M21 8L0 8" stroke="#1e1e20"/></svg></a>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="blog-post-box-wrap position-relative w-100">
                            <div class="blog-post-box w-100">
                                <div class="blog-post-img position-relative overflow-hidden w-100"><a href="blog-detail.html" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/blog-post-img1-3.jpg" alt="Blog Post Image 3"></a></div>
                                <div class="blog-post-info position-relative w-100">
                                    <a class="thm-bg position-absolute" href="blog-detail.html" title=""><svg viewBox="0 0 28 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M28 8L20.5 14.9282L20.5 1.0718L28 8Z" fill="#1e1e20"/><path d="M21 8L0 8" stroke="#1e1e20"/></svg></a>
