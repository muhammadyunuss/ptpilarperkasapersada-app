            ...
            <div class="container">
                <div class="page-top-inner d-flex flex-wrap align-items-center position-relative w-100">
                    ...
                    <div class="page-title-img position-absolute">
                        <div class="page-title-img-inner d-block w-100" style="background-image: url({{ asset('front') }}/assets/images/page-title-bg1-2.jpg);"></div><span class="position-absolute sec-watermark center-watermark overlap-btm-shap88 font-200">Blog</span>
                    </div>
                </div>
            </div>
        </div><!-- Page Top Wrap -->
                        ...
                        <div class="post-detail position-relative w-100">
                            ...
                            <div class="post-detail-desc w-100">
                                ...
                                <blockquote class="blockquote position-relative">
                                    <div class="blockquote-footer position-relative">George Davies</div><i class="lft-qut icon-quote-left thm-clr position-absolute"></i>
                                    <p class="mb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti sint occaecati cupiditate non provident.</p><i class="rgt-qut icon-quote-right thm-clr position-absolute"></i>
                                </blockquote>
