                    ...
                    <div class="feat-item w-100 d-flex flex-wrap position-relative justify-content-end">
                        ...
                        <div class="feat-cap-wrap position-absolute">
                            <div class="feat-cap position-relative">
                                ...
                                <a class="thm-btn thm-bg d-inline-block position-relative" href="{{ url('/portofolio-single') }}" title="">Learn More<span class="brd-tp-lft"></span><span class="brd-btm-rgt"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="feat-item w-100 d-flex flex-wrap position-relative justify-content-end">
                        ...
                        <div class="feat-cap-wrap position-absolute">
                            <div class="feat-cap position-relative">
                                ...
                                <span class="d-block thm-clr">PT Pilar Perkasa</span>
                                <h2 class="mb-0">One Of The Best Construction</h2>
                                <a class="thm-btn thm-bg d-inline-block position-relative" href="{{ route('portofolio-single') }}" title="">Learn More<span class="brd-tp-lft"></span><span class="brd-btm-rgt"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="serv-box2-wrap mt-100 position-relative d-block w-100">
                            ...
                            <div class="serv-box2 position-relative w-100">
                                <div class="serv-img2 position-relative overflow-hidden w-100"><a class="thm-btn thm-bg d-inline-block position-absolute" href="{{ route('service') }}" title="">More<span class="brd-tp-lft"></span><span class="brd-btm-rgt"></span></a><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/serv-img2-1-1.jpg" alt="Service Image 1"></div>
        ...
        <div class="container">
            ...
            <div class="projects-wrap2 position-relative w-100">
                <div class="proj-box2 position-relative w-100">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-lg-7">
                            <div class="proj-img2 position-relative w-100"><div class="proj-bg opc-6 position-absolute" style="background-image: url({{ asset('front') }}/assets/images/resources/proj-bg1-2.png);"></div><a href="{{ route('portofolio-single') }}" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/proj-img2-4.jpg" alt="Project Image 1"></a></div>
                        </div>
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            <div class="proj-info2 position-relative w-100">
                                <h3 class="mb-0"><i class="icon-construction thm-clr"></i><a href="{{ route('portofolio-single') }}" title="">Reconstruction Cultural Hall</a></h3>
                ...
                <div class="proj-box2 rev position-relative w-100">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-lg-7 order-md-1">
                            <div class="proj-img2 position-relative w-100"><div class="proj-bg opc-6 position-absolute" style="background-image: url({{ asset('front') }}/assets/images/resources/proj-bg2-1.png);"></div><a href="{{ route('portofolio-single') }}" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/proj-img2-5.jpg" alt="Project Image 2"></a></div>
                        </div>
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            <div class="proj-info2 position-relative w-100">
                                <h3 class="mb-0"><i class="icon-hotel thm-clr"></i><a href="{{ route('portofolio-single') }}" title="">Minimalist Hotel</a></h3>
                                <p class="mb-0">Duis aute irure dolor pariatur reprehenderit in voluptate velit esse cillum dolore eu fugiat</p>
                                <a class="d-inline-block thm-clr" href="{{ route('portofolio-single') }}" title="">Learn More</a>
                ...
                <div class="proj-box2 position-relative w-100">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-lg-7">
                            <div class="proj-img2 position-relative w-100"><div class="proj-bg opc-6 position-absolute" style="background-image: url({{ asset('front') }}/assets/images/resources/proj-bg3-1.png);"></div><a href="{{ route('portofolio-single') }}" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/proj-img2-6.jpg" alt="Project Image 3"></a></div>
                        </div>
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            <div class="proj-info2 position-relative w-100">
                                <h3 class="mb-0"><i class="icon-real-estate thm-clr"></i><a href="{{ route('portofolio-single') }}" title="">Modern Villa</a></h3>
                                <p class="mb-0">Duis aute irure dolor pariatur reprehenderit in voluptate velit esse cillum dolore eu fugiat</p>
                                <a class="d-inline-block thm-clr" href="{{ route('portofolio-single') }}" title="">Learn More</a>
                                <div class="proj-info-list-wrap d-flex flex-wrap justify-content-end w-100">
                                    <ul class="proj-info-list2 mb-0 list-unstyled">
...
<section>
    <div class="w-100 position-relative">
        ...
        <div class="view-all mt-70 text-center w-100">
            <a class="thm-btn thm-bg d-inline-block position-relative" href="{{ route('tentang-perusahaan') }}" title="">Learn More<span class="brd-tp-lft"></span><span class="brd-btm-rgt"></span></a>
        </div><!-- View All -->
    </div>
</section>
<section>
                        ...
                        <div class="blog-post-box-wrap position-relative w-100">
                            <div class="blog-post-box w-100">
                                ...
                                <div class="blog-post-info position-relative w-100">
                                    <a class="thm-bg position-absolute" href="{{ route('blog-detail') }}" title=""><svg viewBox="0 0 28 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M28 8L20.5 14.9282L20.5 1.0718L28 8Z" fill="#1e1e20"/><path d="M21 8L0 8" stroke="#1e1e20"/></svg></a>
