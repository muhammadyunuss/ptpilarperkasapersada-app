            ...
            <div class="container">
                <div class="page-top-inner d-flex flex-wrap align-items-center position-relative w-100">
                    ...
                    <div class="page-title-img position-absolute">
                        <div class="page-title-img-inner d-block w-100" style="background-image: url({{ asset('front') }}/assets/images/page-title-bg1-2.jpg);"></div><span class="position-absolute sec-watermark center-watermark overlap-btm-shap88 font-200">VisiMisi</span>
                    </div>
                </div>
            </div>
        </div><!-- Page Top Wrap -->
                        ...
                        <div class="founder-desc-wrap w-100">
                            ...
                            <div class="founder-desc w-100">
                                <blockquote class="blockquote position-relative">
                                    <div class="blockquote-footer position-relative">Visi</div><i class="lft-qut icon-quote-left thm-clr position-absolute"></i>
                                    <p class="mb-0">Menjadi perusahaan dibidang penyedia barang dan jasa, earth work, general kontraktor dan supplier dengan ditunjang total quality management yang memberikan total service bagi pengguna jasa diseluruh Indonesia</p><i class="rgt-qut icon-quote-right thm-clr position-absolute"></i> <br>

                                    <div class="blockquote-footer position-relative">Misi</div><i class="lft-qut icon-quote-left thm-clr position-absolute"></i>
                                    <p class="mb-0">1. Memberikan pelayanan, mutu dan kepuasan yang terbaik kepada pelanggan</p>
                                    <p class="mb-0">2. Membangun serta menciptakan citra terbaik perusahaan</p>
                                    <p class="mb-0">3. Turut berpartisipasi dalam pembangunan negara kesatuan republik Indonesia</p><i class="rgt-qut icon-quote-right thm-clr position-absolute"></i>
                                </blockquote>
                            </div>
                        </div>
                    </div>
