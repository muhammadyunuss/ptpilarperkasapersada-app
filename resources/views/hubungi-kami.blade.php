                ...
                <div class="row">
                    <div class="cont-info-box-wrap position-relative w-100">
                        <div class="cont-info-box position-relative w-100">
                            <span class="thm-bg position-absolute text-center">01<svg viewBox="0 0 43 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M43 8L35.5 14.9282L35.5 1.0718L43 8Z" fill="#1E1E20" />
                                    <path d="M36 8L0 8" stroke="#1E1E20" />
                                </svg></span>
