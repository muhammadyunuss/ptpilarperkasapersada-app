                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#why-choose-tab4"><span class="position-absolute">04</span>Mempunyai Nilai Total Kontrak Sebesar Rp. 14.277.685.000,-</a></li>
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#why-choose-tab5"><span class="position-absolute">05</span>Mempunyai Nilai Total Kontrak Sebesar Rp. 19.012.536.000,-</a></li>
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#why-choose-tab6"><span class="position-absolute">06</span>Mempunyai Nilai Total Kontrak Sebesar Rp. 26.660.000.000,-</a></li>
                        </ul>
                    </div>
                </div>
