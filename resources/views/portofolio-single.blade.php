        ...
        <div class="page-top-wrap position-relative w-100">
            <div class="container">
                <div class="page-top-inner d-flex flex-wrap align-items-center position-relative w-100">
                    ...
                    <div class="page-title-img position-absolute"><div class="page-title-img-inner d-block w-100" style="background-image: url({{ asset('front') }}/assets/images/page-title-bg5.jpg);"></div><span class="position-absolute sec-watermark center-watermark overlap-btm-shap88 font-200">Single</span></div>
                </div>
            </div>
        </div><!-- Page Top Wrap -->
    </div>
...
<section>
    <div class="w-100 pt-80 position-relative">
        <img class="img-fluid sec-btm-lft-shp overlap-tpshap375 opc-3 position-absolute" src="{{ asset('front') }}/assets/images/sec-shap10.jpg" alt="Sec Shape 10">
        <div class="container">
            <div class="port-dtl-wrap position-relative w-100">
                <div class="port-dtl-img position-relative w-100">
                    <div class="port-dtl-img-caro">
                        <div class="port-dtl-img d-block w-100"><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/port-dtl-img1-1.jpg" alt="Portfolio Detail Image 1"></div>
                        <div class="port-dtl-img d-block w-100"><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/port-dtl-img1-2.jpg" alt="Portfolio Detail Image 2"></div>
                        <div class="port-dtl-img d-block w-100"><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/port-dtl-img1-3.jpg" alt="Portfolio Detail Image 3"></div>
                    </div>
                </div>
                ...
                <div class="port-dtl-gal-imgs w-100">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-lg-6"><a class="d-block position-relative overflow-hidden w-100" href="{{ asset('front') }}/assets/images/resources/port-dtl-gal-img1.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/port-dtl-gal-img1.jpg" alt="Portfolio Detail Gallery Image 1"></a></div>
                        <div class="col-md-6 col-sm-6 col-lg-6"><a class="d-block position-relative overflow-hidden w-100" href="{{ asset('front') }}/assets/images/resources/port-dtl-gal-img2.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/port-dtl-gal-img2.jpg" alt="Portfolio Detail Gallery Image 2"></a></div>
                    </div>
                </div>
...
<section>
    <div class="w-100 pt-130 pb-70 position-relative">
        <img class="img-fluid sec-btm-rgt-shp opc-03 position-absolute" src="{{ asset('front') }}/assets/images/sec-shap9.jpg" alt="Sec Shape 9">
        <div class="container">
            ...
            <div class="rlt-port-wrap position-relative w-100">
                <div class="row mrg45 rlt-port-caro">
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="port-box v2 position-relative w-100">
                            <div class="port-img position-relative overflow-hidden w-100">
                                <img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/rlt-port-img1-1.jpg" alt="Related Portfolio Image 1">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="port-box v2 position-relative w-100">
                            <div class="port-img position-relative overflow-hidden w-100">
                                <img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/rlt-port-img1-2.jpg" alt="Related Portfolio Image 2">
                                <a class="thm-btn thm-bg d-inline-block position-absolute" href="portfolio-single.html" title="">View<span class="brd-tp-lft"></span><span class="brd-btm-rgt"></span></a>
                            </div>
                            <div class="port-info position-relative w-100">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="port-box v2 position-relative w-100">
                            <div class="port-img position-relative overflow-hidden w-100">
                                <img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/rlt-port-img1-3.jpg" alt="Related Portfolio Image 3">
                                <a class="thm-btn thm-bg d-inline-block position-absolute" href="portfolio-single.html" title="">View<span class="brd-tp-lft"></span><span class="brd-btm-rgt"></span></a>
                            </div>
                            <div class="port-info position-relative w-100">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="port-box v2 position-relative w-100">
                            <div class="port-img position-relative overflow-hidden w-100">
                                <img class="img-fluid w-100" src="{{ asset('front') }}/assets/images/resources/rlt-port-img1-4.jpg" alt="Related Portfolio Image 4">
                                <a class="thm-btn thm-bg d-inline-block position-absolute" href="portfolio-single.html" title="">View<span class="brd-tp-lft"></span><span class="brd-btm-rgt"></span></a>
                            </div>
                            <div class="port-info position-relative w-100">
